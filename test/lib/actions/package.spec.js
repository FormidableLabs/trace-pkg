...
describe("lib/actions/package", () => {
  ...
  it("allows unresolved dynamic misses and bail when in dry run", async () => {
    const errStub = sandbox.stub(console, "error");
    ...
    expect(logStub)
      .to.have.been.calledWithMatch("Would create 2 packages:").and
      .to.have.been.calledWithMatch("WARN", "Dynamic misses in one.zip:");
